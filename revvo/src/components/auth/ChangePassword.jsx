...
const ChangePassword = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      setError(error.message || 'Falha ao definir a senha. Por favor, tente novamente.');
    } finally {
      setIsLoading(false);
    }
  };
    ...
    <div className="flex min-h-screen">
      ...
      <div className="w-full lg:w-1/2 flex flex-col items-center justify-center p-8">
        <div className="w-full max-w-md">
          ...
          />
          <h2 className="text-2xl font-onest font-semibold text-center mb-8">Definir senha</h2>
          ...
          {successMessage ? (
            <div className="space-y-6">
              ...
              <p className="text-center text-sm text-gray-600">Redirecionando para o dashboard...</p>
            </div>
          ) : (
